...
const weeklyMenu: DaySchedule[] = [
  {
    ...
    lunch: {
      name: 'Empanadas',
      description: 'Crispy hand-made empanadas filled with seasoned beef, olives, and spices. Served with chimichurri.',
    ...
    dinner: {
      ...
      description: 'Tender grass-fed beef strips with bell peppers, onions, and garlic in savory sauce. Served with jasmine rice.',
  ...
  },
  {
    ...
    lunch: {
      name: 'Quesadillas',
      description: 'Grilled flour tortillas stuffed with melted cheese, chicken, peppers, and onions. Served with salsa and sour cream.',
    ...
    dinner: {
      ...
      description: 'Wild-caught salmon fillet with crispy roasted potatoes, asparagus, and lemon dill sauce.',
  ...
  },
  {
    ...
    lunch: {
      name: 'Spring Chicken',
      description: 'Herb-roasted free-range chicken breast with spring vegetables and red pepper sauce.',
    ...
    dinner: {
      name: "Mom's Meatloaf",
      description: 'Classic homestyle meatloaf with rich gravy, creamy mashed potatoes, and seasonal vegetables.',
  ...
  },
  {
    ...
    lunch: {
      ...
      description: 'Breaded chicken breast stuffed with ham and Swiss cheese, served with creamy dijon sauce and greens.',
    ...
    dinner: {
      name: 'Steak Salad',
      description: 'Grilled grass-fed sirloin over mixed greens with blue cheese, avocado, and balsamic vinaigrette.',
  ...
  },
  {
    ...
    lunch: {
      ...
      description: 'House-made potato gnocchi in creamy truffle sauce with parmesan and fresh herbs.',
    ...
    dinner: {
      ...
      description: 'Layers of fresh pasta, slow-cooked beef ragu, bechamel, and melted mozzarella. A family favorite.',
...
const WeeklySchedule = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <SEOHead
        {...pageSEO.menu}
        title="Weekly Menu Schedule | Secret Menu SF"
        description="View our weekly rotating menu. Fresh chef-prepared meals delivered to your door. Monday through Friday lunch and dinner options."
